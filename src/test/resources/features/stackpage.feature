...
Background: The user is on the sign-in page with login credentials
 ...
 Scenario: Verify that user is able to navigate to Try Here page for Operations in Stack page
  ...
  Scenario Outline: User verify the output for valid, invalid and incorrect syntax Python code operation in stack page
    Given User at Try Editor page for the Operations in Stack page
    When User enters valid, invalid and incorrect syntax code from excel sheet '<Sheetname>' and <RowNumber> and clicks on Run button
  ...
  Scenario Outline: User verify the output for valid, invalid and incorrect syntax Python code for implementation page
   ...
   Scenario Outline: User verify the output for valid, invalid and incorrect syntax Python code for Applications page
