...
Scenario: Verify user land on Applications of Array page in Array section
 ...
 Scenario Outline: Verify user is able to navigate to Search The Array of Practice Questions page 
    ...
    When user enter the invalid pythoncode getting input from sheet '<Sheetname>' and <RowNumber> in search the array for practice questions submit button
  ...
  Scenario Outline: Verify that user is able to run valid python code for Max Consecutive Ones page
    ...
    When The user enter the valid python code input from sheet '<Sheetname>' and <RowNumber> in Max Consecutive Ones page and clicks on run and submit button
 ...
 Scenario Outline: Verify user is able to run invalid python code for Max Consecutive Ones page
    ...
    When The user enter the invalid python code input from sheet '<Sheetname>' and <RowNumber> in Max Consecutive Ones page and clicks on run and submit button
 ...
 Scenario Outline: Verify that user is able to run valid python code for Find Numbers with Even Number of Digits page
    Given The user navigate to try editor of Find Numbers with Even Number of Digits page
    When The user enter the valid python code input from sheet '<Sheetname>' and <RowNumber> in Find Numbers with Even Number of Digits page and clicks on run and submit button
 ...
 Scenario Outline: Verify user is able to run invalid python code for Find Numbers with Even Number of Digits page
    ...
    When The user enter the invalid python code input from sheet '<Sheetname>' and <RowNumber> in Find Numbers with Even Number of Digits page and clicks on run and submit button
...
Scenario Outline: Verify that user is able to run valid python code for Squares of a Sorted Array page
   ...
   When The user enter the valid python code input from sheet '<Sheetname>' and <RowNumber> in Squares of a Sorted Array page and clicks on run and submit button
...
Scenario Outline: Verify that user is able to run invalid python code for Squares of a Sorted Array page
   ...
   When The user enter the invalid python code input from sheet '<Sheetname>' and <RowNumber> in Squares of a Sorted Array page and clicks on run and submit button
