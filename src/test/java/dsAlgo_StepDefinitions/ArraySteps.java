...
public class ArraySteps {
	...
	public void user_enter_the_valid_pythoncode_input_from_sheet_and_in_array_module_and_clicks_on_run_button(
	...
	public void user_enter_the_invalid_pythoncode_input_from_sheet_and_in_array_module_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readDataFromExcelSheet(sheetName, rowNumber);
		arrayPage.textAreaSendKey();
		arrayPage.runButtonClick();
	...
	public void user_enter_the_valid_pythoncode_getting_input_from_sheet_and_in_array_using_list_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readDataFromExcelSheet(sheetName, rowNumber);
		arrayPage.textAreaSendKey();
		arrayPage.runButtonClick();
	...
	public void user_enter_the_invalid_pythoncode_input_from_sheet_and_in_array_using_list_module_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readDataFromExcelSheet(sheetName, rowNumber);
		arrayPage.textAreaSendKey();
		arrayPage.runButtonClick();
	...
	public void user_enter_the_valid_pythoncode_getting_input_from_sheet_and_in_basic_operation_in_list_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readDataFromExcelSheet(sheetName, rowNumber);
		arrayPage.textAreaSendKey();
		arrayPage.runButtonClick();
	...
	public void user_enter_the_invalid_pythoncode_input_from_sheet_and_in_basic_operation_in_list_module_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readDataFromExcelSheet(sheetName, rowNumber);
		arrayPage.textAreaSendKey();
		// arrayPage.runButtonWithAlert();
	...
	public void user_enter_the_valid_pythoncode_getting_input_from_sheet_and_in_applications_of_array_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readDataFromExcelSheet(sheetName, rowNumber);
		arrayPage.textAreaSendKey();
		arrayPage.runButtonClick();
	...
	public void user_enter_the_invalid_pythoncode_getting_input_from_sheet_and_in_applications_of_array_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readDataFromExcelSheet(sheetName, rowNumber);
		arrayPage.textAreaSendKey();
		// arrayPage.runButtonWithAlert();
	...
	public void user_navigate_to_search_the_array_for_practice_questions_run_button() {
		...
		arrayPage.practiceQuestionsSearchTheArray();
		LoggerReader.info(
				"User at the try editor page of Pactice Questions ******** search_the_array_for_practice_questions_run_button ");
	}
	...
	public void user_enter_the_valid_pythoncode_getting_input_from_sheet_and_in_search_the_array_for_practice_questions_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
	...
	public void user_enter_the_valid_pythoncode_getting_input_from_sheet_and_in_search_the_array_for_practice_questions_with_submit_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
	...
	public void user_navigate_to_search_the_array_for_practice_questions_with_run_button() {
		...
		arrayPage.practiceQuestionsSearchTheArray();
		LoggerReader.info(
				"User at try editor page for Invalid code of Pactice Questions ******** search_the_array_for_practice_questions_run_button ");
	}
	...
	public void user_enter_the_invalid_pythoncode_getting_input_from_sheet_and_in_search_the_array_for_practice_questions_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
	...
	public void the_user_enter_the_valid_python_code_input_from_sheet_and_in_max_consecutive_ones_page_and_clicks_on_submit_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
	...
	public void the_user_should_able_to_see_output_in_the_console() {
		LoggerReader.info(
				"User navigate with valid code to the try editor page of Max Consecutive Ones run and submit button ");
		// arrayPage.logResultOutput();
	}
	...
	public void the_user_enter_the_invalid_python_code_input_from_sheet_and_in_max_consecutive_ones_page_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readExcelRun(sheetName, rowNumber);
	...
	public void user_should_able_to_see_output_in_the_console() {
		LoggerReader.info(
				"User navigate with invalid code to the try editor page of Max Consecutive Ones run and submit button ");
		arrayPage.logResultOutput();
	}
	...
	public void the_user_enter_the_invalid_python_code_input_from_sheet_and_in_max_consecutive_ones_page_and_clicks_on_run_button_exception(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readExcelRun(sheetName, rowNumber);
	}
	...
	public void user_should_able_to_see_output_in_the_console_exception() {
		LoggerReader.info(
				"User navigate with invalid code to the try editor page of Max Consecutive Ones run and exception submit button ");
		// arrayPage.logResultOutput();
	}
	...
	public void the_user_enter_the_valid_python_code_input_from_sheet_and_in_find_numbers_with_even_number_of_digits_page_and_clicks_on_run_button(
			String sheetName, Integer rowNumberNum) throws IOException, InterruptedException {
	...
	public void the_user_should_be_able_to_see_the_output_in_the_console() {
		...
		LoggerReader.info(
				"User navigate with valid code to the try editor page of Find Numbers with Even Number of Digits page run button ");
		// arrayPage.logResultOutput();
	}
	...
	public void the_user_enter_the_valid_python_code_input_from_sheet_and_in_find_numbers_with_even_number_of_digits_page_and_clicks_on_submit_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
	...
	public void the_user_enter_the_invalid_python_code_input_from_sheet_and_in_find_numbers_with_even_number_of_digits_page_and_clicks_on_run_exception_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readExcelRun(sheetName, rowNumber);
	}
	...
	public void user_should_able_to_see_the_output_in_the_console() {
		LoggerReader.info(
				"User navigate with invalid code to the try editor page of Find Numbers with Even Number of Digits page run button with exception ");
	}
	...
	public void the_user_enter_the_valid_python_code_input_from_sheet_and_in_squares_of_a_sorted_array_page_and_clicks_on_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		// arrayPage.readExcelRun(sheetName, rowNumber);
		// Thread.sleep(5000);
	}
	...
	public void the_user_enter_the_valid_python_code_input_from_sheet_and_in_squares_of_a_sorted_array_page_and_clicks_on_submit_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readExcelSubmit(sheetName, rowNumber);
		Thread.sleep(5000);
	}
	...
	public void the_user_enter_the_invalid_python_code_input_from_sheet_and_in_squares_of_a_sorted_array_page_and_clicks_on_exception_run_button(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		arrayPage.readExcelRun(sheetName, rowNumber);
	}
