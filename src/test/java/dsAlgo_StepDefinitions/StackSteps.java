...
public class StackSteps {
	...
	public void user_enters_valid_syntax_code_from_excel_sheet_and_and_clicks_on_run_button(String sheetName,
			Integer rowNumber) throws IOException, InterruptedException {
	...
	public void user_enters_valid_code_from_excel_sheet_and_and_clicks_on_run_button_for_implementation_page(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		stackPage.tryEditorWindow(sheetName, rowNumber);
	}
	...
	public void user_enters_valid_invalid_and_incorrect_syntax_code_from_excel_sheet_and_and_clicks_on_run_button_for_implementation_page(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		stackPage.tryEditorWindow(sheetName, rowNumber);
	}
	...
	public void user_enters_valid_code_from_excel_sheet_and_and_clicks_on_run_button_for_applications_page(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		stackPage.tryEditorWindow(sheetName, rowNumber);
	}
	...
	public void user_enters_valid_invalid_and_incorrect_syntax_code_from_excel_sheet_and_and_clicks_on_run_button_for_applications_page(
			String sheetName, Integer rowNumber) throws IOException, InterruptedException {
		stackPage.tryEditorWindow(sheetName, rowNumber);
	}
